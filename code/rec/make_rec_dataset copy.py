...
det_data_dir = Path(f"/home/det/dataset"),
det_label_files = [
    Path(f"/home/det/dataset/train_label.txt")
    Path(f"/home/det/dataset/val_label.txt")
    Path(f"/home/det/dataset/test_label.txt")
]

det_label_file = ,
rec_data_dir = Path(f"/home/rec/dataset"),
