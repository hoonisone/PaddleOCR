...
def main(args):
    ...
    # print(f"(5/{n}) Check |train|val|test| ratio per class")#######################################################
    # train = class_ratio_check("/home/det/dataset/train_label.txt")
    # val = class_ratio_check("/home/det/dataset/val_label.txt")
    # test = class_ratio_check("/home/det/dataset/test_label.txt")
